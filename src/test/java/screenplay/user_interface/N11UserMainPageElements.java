...
public class N11UserMainPageElements {
    public static final Target USER_ACC_LINK = Target.the("user main page account link").locatedBy(".user.menuLink");
    ...
    public static final Target CONTRACT_POPUP_CLOSE_BUTTON = Target.the("contract popup close button").locatedBy("#userAgreementLB .content .closeBtn");
}
